...
NBASE_OBJECT*                           nbase_eval_unary(nbase_eval_node* pNode, uint16_t pOper, nbase_eval_node* pNodeOut);
NBASE_OBJECT*                           nbase_eval_binary(nbase_eval_node* pNodeLeft, nbase_eval_node* pNodeRight,
                                            uint16_t pOper, nbase_eval_node* pNodeOut);
NBASE_BOOL                              nbase_eval_expression(nbase_eval_node* pNodeLeft, nbase_eval_node* pNodeRight,
                                            uint16_t pOper, nbase_eval_node* pNodeOut);
...
NBASE_OBJECT* nbase_eval_binary_(nbase_eval_node* pNodeLeft, nbase_eval_node* pNodeRight,
    uint16_t pOper, nbase_eval_node* pNodeOut)
{
#if 0
...
/*NBASE_OBJECT**/NBASE_BOOL nbase_eval_expression(/*NBASE_OBJECT* pNode*/nbase_eval_node* pNodeLeft, nbase_eval_node* pNodeRight,
    uint16_t pOper, nbase_eval_node* pNodeOut)
{
    if(!pNodeLeft)
        return NBASE_FALSE;

    //switch(pNodeLeft->data_type)
